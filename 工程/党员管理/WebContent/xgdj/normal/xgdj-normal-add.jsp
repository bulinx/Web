...
<nav class="breadcrumb">
    ...
    入党信息 <span class="c-gray en">&gt;</span> 转正申请
...
<div class="pd-20">
    <form action="normal!update" method="post" class="form form-horizontal" id="form-user-add">
        <div class="row cl">
            <label class="form-label col-3">学号：</label>
            <div class="formControls col-6">
                <input type="text" class="input-text" value="${obj.number}" name="data.number" readonly="readonly" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-3">入党时间：</label>
            <div class="formControls col-6">
                <input type="text" class="input-text laydate-icon" readonly="readonly" placeholder="入党时间" value="${obj.passDate}" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-3">预备党员培训情况：</label>
            <div class="formControls col-6">
                <input type="text" class="input-text" name="data.prepTrain" placeholder="预备党员培训情况" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            <label class="form-label col-3">转正时间：</label>
            <div class="formControls col-6">
                <input type="text" class="input-text laydate-icon" onclick="laydate();" placeholder="转正时间" name="data.normalDate" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            <label class="form-label col-3">讨论意见：</label>
            <div class="formControls col-6"> <span class="select-box">
        <select class="select" size="1" id="discuss" name="data.discuss" datatype="*" nullmsg="*必选">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text laydate-icon" onclick="laydate();" placeholder="分党委审批时间" name="data.normalApproveDate" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
