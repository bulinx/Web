...
<nav class="breadcrumb">
	...
	申请审核 <span class="c-gray en">&gt;</span> 入党申请
...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20" style="width: auto;">
        <span class="l">
            <a roles="a51c-79" href="javascript:void(0);" onclick="stop();" class="btn btn-danger radius">
				<i class="icon-trash"></i> 批量退回
			</a>
            <a roles="7e53-79" href="javascript:void(0);" onclick="pass();" class="btn btn-primary radius">
				<i class="icon-plus"></i> 批量通过
			</a>
			<a roles="b327-79" href="ReportServer?reportlet=xgdj_apply.cpt" target="_blank" class="btn btn-default radius">
...
<script type="text/javascript">
	...
	$('.table-sort').dataTable({
		...
		"aoColumnDefs" : [
			...
			{
				"orderable" : false,
				"aTargets" : [ 0,2,3,4,5,6,8,9,12,13]
			} // 制定列不参与排序
		]
	});
