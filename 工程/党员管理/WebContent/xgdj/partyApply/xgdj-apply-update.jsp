...
<div class="pd-20">
    <form action="partyApply!update" method="post" class="form form-horizontal" id="form-user-add">
        <input type="hidden" name="data.id" value="${obj.id}">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" value="${obj.name}" class="input-text" name="data.name" placeholder="姓名" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text" placeholder="身份证" name="data.idCard"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text" value="${obj.sex}" readonly="readonly" placeholder="性别" name="data.sex" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text laydate-icon" value="${obj.birthday}" onclick="laydate();" placeholder="出生日期" name="data.birthday" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text" name="data.company" value="${obj.company}" placeholder="学生所在班级" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
        ...
        <select class="select" size="1" id="nation" name="data.nation" datatype="*" nullmsg="*必选">
            <option value="${obj.nation}" selected>--${obj.nation}--</option>
        </select>
        </span></div>
            <div class="col-3"></div>
        </div>
        ...
        <select class="select" size="1" id="culture" name="data.culture" datatype="*" nullmsg="*必选">
            <option value="${obj.culture}" selected>--${obj.culture}--</option>
        </select>
        </span></div>
            <div class="col-3"></div>
        </div>
       <div class="row cl">
        ...
        <select class="select" size="1" id="job" name="data.job" datatype="*" nullmsg="*必选">
            <option value="${obj.job}" selected>--${obj.job}--</option>
        </select>
        </span></div>
            <div class="col-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" value="${obj.partyDate}" class="input-text laydate-icon" onclick="laydate();" placeholder="申请入党时间" name="data.partyDate" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" value="${obj.viewDate}" class="input-text laydate-icon" onclick="laydate();" placeholder="列入考察时间" name="data.viewDate">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
        ...
        <select class="select" size="1" name="data.partySchool" datatype="*" nullmsg="*必选">
            <option value="${obj.partySchool}" selected>--${obj.partySchool}--</option>
        ...
        <select class="select" size="1" name="data.youth" datatype="*" nullmsg="*必选">
            <option value="${obj.youth}" selected>--${obj.youth}--</option>
            <option value="是">是</option>
            <option value="否">否</option>
        </select>
        </span></div>
