...
<nav class="breadcrumb">
    ...
    入党信息 <span class="c-gray en">&gt;</span> 拟发展申请
...
<div class="pd-20">
    <form action="develop!update" method="post" class="form form-horizontal" id="form-user-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <input type="text" class="input-text"name="data.train" placeholder="培训情况" datatype="*" nullmsg="*必填">
            </div>
            <div class="col-3"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-6">
                <textarea name="data.honor"  class="textarea"  placeholder="例：2011年11月被湖北民族大学评为三好学生标兵" datatype="*1-200" dragonfly="true" nullmsg="不能为空！" onKeyUp="textarealength(this,200)"></textarea>
