...
<div class="pd-20">
    <div class="text-c">
        <form action="menu!search" method="post" style="display: inline;" id="sea">
            <input value="${key}" id="name" type="text" class="input-text" style="width:250px" placeholder="菜单名称" name="key">
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tr class="text-c">
            ...
            <td class="f-14 article-manage">
                ...
                <a roles="b29a-40" style="text-decoration:none" class="ml-5" onclick="edit('650','450','字典编辑','pages/author/menu-edit.jsp?id=${list.id}')" href="javascript:void(0);" title="编辑"><i class="icon-edit"></i></a>
                <a roles="c391-40" title="删除" href="javascript:void(0);" onclick="del(this,'${list.id}')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a>
            </td>
        </tr>
        </c:if>
