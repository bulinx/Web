...
<nav class="breadcrumb">
    ...
    日志管理 <span class="c-gray en">&gt;</span> 操作日志 <a
...
<div class="pd-20">
    <div class="text-c">
        <form action="operate!search" method="post" id="sea">
            日期范围： <input type="text" placeholder="开始时间" value="${start}" 
            ...
            - <input type="text" placeholder="结束时间" value="${end}" 
                     onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d %H:%m:%s'})"
                     id="datemax" name="end" class="input-text Wdate" style="width: 180px;">
            <input type="text" class="input-text" style="width: 150px"
                   placeholder="操作人" name="log.operateBy" id="operateBy" value="${log.operateBy}">
            <input type="text" class="input-text" style="width: 150px"
                   placeholder="关键字" name="log.keywords" id="keywords" value="${log.keywords}">
