...
<div class="pd-20">
    <div class="text-c">
        <form action="views!search" method="post" id="sea">
            ...
            <input type="text" class="input-text" style="width: 150px"
                   placeholder="访问IP" name="views.ip" id="ip" value="${views.ip}">
            <input type="text" class="input-text" style="width: 150px"
                   placeholder="访问地点" name="views.address" id="address" value="${views.address}">
