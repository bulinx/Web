...
<div class="pd-20">
    <div class="text-c">
        <form action="operate!search" method="post">
            ...
            <input type="text" class="input-text" style="width: 150px"
                   placeholder="操作人" name="log.operateBy" id="operateBy">
            <input type="text" class="input-text" style="width: 150px"
                   placeholder="关键字" name="log.keywords" id="keywords">
    ...
    laypage({
        ...
        jump: function(e, first){ //触发分页后的回调
            if(!first){ //一定要加此判断，否则初始时会无限刷新
            	window.location.href = "operate?currentPage=" + e.curr;
            }
        }
    });
