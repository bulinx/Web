...
<div class="pd-20">
  <div class="text-c">
    ...
    <form action="dictionary!searchDic" method="post" style="display: inline;">
      <input type="text" class="input-text" style="width:250px" placeholder="输入字典名称" name="dictionary.name">
...
laypage({
    ...
    jump: function(e, first){ //触发分页后的回调
        if(!first){ //一定要加此判断，否则初始时会无限刷新
            location.href = 'dictionary?currentPage='+e.curr;
        }
    }
});
