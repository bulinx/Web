...
<div class="pd-20">
    <div class="text-c">
        <form action="users!search" method="post" id="sea">
            日期范围：
            <input type="text" id="datemin" name="start" class="input-text Wdate" style="width: 180px;"
                   onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d %H:%m:%s'})"
                    placeholder="开始时间" value="${start}">
            - <input type="text" id="datemax" name="end" class="input-text Wdate" style="width: 180px;"
                     onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'%y-%M-%d %H:%m:%s'})"
                     placeholder="开始时间" value="${end}">
            <input value="${users.name}" type="text" class="input-text" style="width:150px" placeholder="用户名" name="users.name" id="key">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="javascript:void(0);" onclick="add('550','320','添加用户','pages/user/user-system-add.jsp')" class="btn btn-primary radius">
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <c:if test="${list.state==0}">
            ...
            <td class="f-14 article-manage">
                <a style="text-decoration:none" onClick="stop(this,'${list.id}')" href="javascript:void(0);" title="停用"><i class="icon-hand-down"></i></a>
                <a style="text-decoration:none" class="ml-5" onclick="edit('450','300','编辑','pages/user/user-system-edit.jsp?id=${list.id}')" href="javascript:void(0);" title="编辑"><i class="icon-edit"></i></a>
                <a style="text-decoration:none" class="ml-5" onClick="reset_password('${list.id}')" href="javascript:void(0);" title="重置密码">
                    <i class="icon-key"></i>
                </a>
                <a title="删除" href="javascript:void(0);" onclick="del(this,'${list.id}')" class="ml-5" style="text-decoration:none"><i class="icon-trash"></i></a>
            </td>
            </td>
        	</tr>
        </c:if>
        ...
        <tr class="text-c">
            ...
            <td class="f-14 article-manage">
                <a style="text-decoration:none" onClick="start(this,'${list.id}')" href="javascript:void(0);" title="启用"><i class="icon-hand-up"></i></a>
                <a style="text-decoration:none" class="ml-5" onclick="edit('450','300','编辑','pages/user/user-system-edit.jsp?id=${list.id}')" href="javascript:void(0);" title="编辑"><i class="icon-edit"></i></a>
                <a style="text-decoration:none" class="ml-5" onClick="reset_password('${list.id}')" href="javascript:void(0);" title="重置密码">
                    <i class="icon-key"></i>
                </a>
